...
namespace Academic.Application.Responses.Department
{
    public class DepartmentResponse
    {
        ...
        public DepartmentResponse(int id, DateTime createdAt, DateTime? updatedAt, string code, string name, IReadOnlyCollection<CourseSimpleResponse> courses, IReadOnlyCollection<int> teachersId)
        {
            Id = id;
            CreatedAt = createdAt;
            UpdatedAt = updatedAt;
